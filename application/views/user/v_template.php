...
<body class="animsition">
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="#" class="logo">
						<img src="<?php echo base_url(); ?>assets/images/icons/logo-it.png" alt="IMG-LOGO">
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="<?= base_url('index.php/user/pesan'); ?>">Pesan Jaket</a>
							</li>
							<li>
								<a href="<?= base_url('index.php/user/logout'); ?>">Log Out</a>
							</li>
							<?php } else {?>
							<li>
	...
	<?php
	if (isset($tampilan_user)) {
		$this->load->view($tampilan_user);
	}
	?>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-5 p-b-50">
					...
					<ul>
						...
						Phone: 
							...
							<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
							(0341) 464318, ext 252 - SMS/WA/Telegram <br />(Quick Response) +62 896-896-01317 
							</a>
						</li>
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Ada pertanyaan? silahkan datang ke kantor laboratorium informatika yang berada di GKB 3 lantai 6 di Universitas Muhammadiyah Malang
					</p>
